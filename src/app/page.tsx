        ...
        <main>
          ...
          <section className="mb-10 bg-default px-5 py-10">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="grow-1 bg-white rounded-3xl p-5">
                <strong>
                  Як пекти ідеальний хліб вдома
                </strong>
              </div>
              <div className="grow-1 bg-white rounded-3xl p-5">
                <strong>
                  Малювання з 0, опануй найпростіші техніки і малюй з ними як профі
                </strong>
              </div>
              <div className="grow-1 bg-white rounded-3xl p-5">
                <strong>
                  Історія України - визначні події
                </strong>
              </div>
              <div className="grow-1 bg-white rounded-3xl p-5">
                <strong>
                  Спортивні марафони - для сідниць, пресу, всього тіла і т.д
                </strong>
              </div>
              <div className="grow-1 bg-white rounded-3xl p-5">
                <strong>
                  Красива осанка за 21 день, розблокуй свою спину та зніми біль
                </strong>
              </div>
            </div>
          </section>
          <section className="mb-10">
            ...
            <div>
              <ol className="list-decimal list-inside leading-10">
                ...
                <li>
                  Створення структури міні продукта
                </li>
                <li>
                  Створення програми курсу для міні продукта
                </li>
                <li>
                  Створення лендінгу для міні продукта
                </li>
                <li>
                  Структура лендінгу міні продукта
                </li>
                <li>
                  Запуск реклами для міні продукта
                </li>
                <li>
                  Рекомендації щодо креативів🎁
                </li>
                <li>
          ...
          <section className="mb-10" id="pay">
            <div className="text-center rounded-2xl bg-default p-5 flex flex-col items-center mb-5">
              ...
              />
              <p className={"text-white text-xl"}><s>2 000 грн</s></p>
              <p className={"font-bold text-white text-3xl uppercase mb-10"}>499 грн</p>
