          ...
          <section>
            <div className="md:basis-7/12 flex-initial grow-0 align-bottom dark:text-black">
              ...
              <ul className="mb-5 list-disc list-inside mt-5 text-xl leading-7">
                ...
                <li><strong>IT блогер:</strong> експертний блог в IG 7к+ аудиторії</li>
          ...
          <section className="mb-10 bg-default px-5 py-10">
              ...
              <div className="flex flex-col gap-5">
                <div className="grow-1 bg-white rounded-3xl p-5">
                  <h3 className="font-bold text-xl mb-3">Для новачків/студентів</h3>
                  <p>
                ...
                <div className="grow-1 bg-white rounded-3xl p-5">
                  <h3 className="font-bold text-xl mb-3">Для власників онлайн бізнесу</h3>
                  <p>
                ...
                <div className="grow-1 bg-white rounded-3xl p-5">
                  <h3 className="font-bold text-xl mb-3">Для експертів, які  хочуть монетизувати свої знання блогу</h3>
                  <p>
                ...
                <div className="grow-1 bg-white rounded-3xl p-5">
                  <h3 className="font-bold text-xl mb-3">Для тих, хто хоче створити свій онлайн продукт</h3>
                  <p>
